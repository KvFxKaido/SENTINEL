...
/ slice96 (the render body's five-verb 96x80 sheets for ?body=render96
...
# The slice declares idle/walk/run/kneel/aim with the render's own frame counts
# (4/8/8/2/2 — the re-frame preserves them). Flat sheet names, no verb
...
if mode == "slice96":
    ...
    print("synthetic sheets: slice96 roster, 5 verbs x 4 facings")
    sys.exit(0)
