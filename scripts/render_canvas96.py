...
Reads  assets/original/cipher_render/sheets/{idle,walk,run,kneel,aim}_{facing}.png
...
# is checked exactly — a missing name would rewrite nineteen strips and
# leave the twentieth stale in sheets96, the partial-set lie the molder
...
EXPECTED = {f"{verb}_{facing}.png"
            for verb in ("idle", "walk", "run", "kneel", "aim")
