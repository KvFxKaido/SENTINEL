...
record's dash block carries the ladder). Six of ten; FIRE stands alone
on the frontier with both its gates (the aim stance and the socket
export) up, and after it: HURT, DEATH, HEAL, ATTACK 1/2, then the
squad.
