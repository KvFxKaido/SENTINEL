...
| Trait | Description |
|-------|-------------|
| **Age** | Late 20s, as she was when she died |
| **Features** | Dark hair, tired eyes that still manage warmth |
| **Presence** | Edges of vision, reflections, moments between waking and sleep |
...
The setting deliberately doesn't confirm which is true:

1. **Actual Ghost** — The supernatural exists in this world
2. **SENTINEL Projection** — It has her memories, voice, psychological profile
3. **Trauma Hallucination** — Viewer's guilt/grief made manifest
4. **Quantum Echo** — Consciousness imprint on reality (weird science)
5. **Narrative Device** — "Real" in the story sense only

> [!info] The Rule
> Never confirm. Let it remain a mystery.
...
- A reminder that the future was worth dying for
...
> "I made a deal with a machine for my son's life. I'd make it again."

> "SENTINEL kept its promise. That's more than most humans manage."
